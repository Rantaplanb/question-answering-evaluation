...
#Ταξιδεύει στη Νέα Υόρκη και εισάγεται για εξετάσεις στο Memorial Hospital, όπου διαπιστώνεται ότι πάσχει από καρκίνο. Έπειτα από πολλαπλές εγχειρήσεις επιστρέφει στο σπίτι ενός φίλου του στο Πόρτο Ράφτη και προσπαθεί να νικήσει την επάρατο νόσο.\
text4="Τα χαράματα της Παρασκευής 8 Φεβρουαρίου ο Νίκος Ξυλούρης απεβίωσε... Στις 9 Φεβρουαρίου χιλιάδες κόσμου, επώνυμοι κι ανώνυμοι, αποχαιρετούν τον «Αρχάγγελο της Κρήτη» με δάκρια στα μάτια και τραγουδούν:"
...
#το κανω αυτό επειδή δε μου μεταφράζει μεγάλα κείμενα, άρα το σπάω σε μικρότερα.
fullText = context[0]["translation_text"]+context2[0]["translation_text"]+context3[0]["translation_text"]+context4[0]["translation_text"]
...
greek1="Ποιος ήταν ο Αρχάγγελος της Κρήτης"
greek2="Τι έπαθε το χωριό του Ξυλούρη"
greek3="Τι πρόβλημα υγείας είχε"
...
answer=qa_model(question = [question[0]["translation_text"],question2[0]["translation_text"],question3[0]["translation_text"]],context=fullText)
print(answer)

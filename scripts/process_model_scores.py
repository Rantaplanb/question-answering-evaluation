...
data = pd.read_csv('../../data_for_processing/model_scores_final.csv', encoding='UTF-16')
questions = data['question']
models = data['model'][:10]
model_answers = data['model_answer']
correct_answers = data['correct_answer']
model_prediction_scores = data['model_prediction_score']

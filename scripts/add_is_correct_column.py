...
input_file = '../resources/csv_files/questions_with_answers_from_all_models_on_xsquad_bing.csv'
output_file = '../resources/csv_files/questions_with_answers_from_all_models_on_xsquad_bing_with_is_correct.csv'
